...
public class Calculator implements ActionListener{
    ...
    Calculator(){
        ...
        frame.getContentPane().setBackground(new Color(100,170,255));
        ...
        negButton.setBounds(20,430,115,50);
        delButton.setBounds(135,430,130,50);
        clrButton.setBounds(265,430,115,50);
        
        panel=new JPanel();
        panel.setBounds(50,100,300,300);
        panel.setLayout(new GridLayout(4,4,10,10));
        panel.setBackground(new Color(100,170,255));
